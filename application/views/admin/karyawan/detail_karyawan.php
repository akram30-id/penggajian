<div class="container">
    <div class="row">
        <a href="<?= base_url() . 'ManagerAdministrasi/data_karyawan'; ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to Datasets</a>
    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        ...
                                        <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#editKaryawan<?= $d->id ?>">
                                            Edit
                                        </button>
                                        <!-- Modal -->
                                        <div class="modal fade" id="editKaryawan<?= $d->id ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="editKaryawanLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editKaryawanLabel">Edit <?= ucwords($d->nama); ?></h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form class="form-group" action="<?= base_url() . 'ManagerAdministrasi/act_edit_karyawan'; ?>" method="POST">
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-4">
                                                                <label for="no_telepon" class="form-label">Gaji Pokok</label>
                                                                <input type="number" name="gapok" class="form-control" id="gapok" value="<?= $d->GajiPokok; ?>">
                                                                    ...
                                                                    <select class="custom-select" name="jabatan" id="jabatan">
                                                                        ...
                                                                        <?php foreach ($jbt as $j) : ?>
                                                                            <option <?php if ($j == $d->jabatan) {
                                                                                        echo "selected = 'selected'";
                                                                                    } ?> value="<?= ucwords($d->jabatan); ?>"><?= ucwords($d->jabatan); ?></option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                </div>
                                                                <div class="col-sm-6 mb-4">
                                    ...
                                    <div class="col-sm-4">
                                        <a href="<?= base_url() . 'ManagerAdministrasi/delete_karyawan/' . $d->id; ?>" onclick="confirm('Are you sure want to delete <?= $d->nama; ?> ?')" type="button" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="modal fade" id="tambahDataIstri" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="tambahDataIstriLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    ?>
                                                    <div class="modal-body">
                                                        <form action="<?= base_url() . 'ManagerAdministrasi/act_tambah_istri/' . $d->id . '/' . $d->nik; ?>" method="POST">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="row justify-content-end">
                                                                            ...
                                                                            <a href="<?= base_url() . 'ManagerAdministrasi/delete_istri/' . $da->idSuamiIstri . '/' . $d->nik . '/' . $da->HubunganSuamiIstri; ?>" class="btn btn-danger mr-3">Hapus</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="modal fade" id="modalIstri" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                ?>
                                                                <div class="modal-body">
                                                                    <form action="<?= base_url() . 'ManagerAdministrasi/act_edit_istri/' . $d->id . '/' . $d->nik; ?>" method="POST">
                                                                        <div class="form-group">
                                                                            <label for="nama">Nama <?= $label; ?></label>
                                        ...
                                        <div class="modal fade" id="tambahDataAnak" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="tambahDataAnakLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= base_url() . 'ManagerAdministrasi/act_tambah_anak/' . $d->id . '/' . $d->nik; ?>" method="POST">
                                                            <div class="form-group">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="row justify-content-end">
                                                                            <button type="button" class="btn btn-secondary mr-3" data-dismiss="modal">Tidak</button>
                                                                            <a href="<?= base_url() . 'ManagerAdministrasi/delete_anak/' . $dn->id_anak . '/' . $d->nik; ?>" class="btn btn-danger mr-3">Hapus</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="modal fade" id="modalAnak<?= $dn->id_anak ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="<?= base_url() . 'ManagerAdministrasi/act_edit_anak/' . $d->id . '/' . $d->nik; ?>" method="POST">
                                                                            <div class="form-group">
                                                                                <label for="nama">Nama Anak</label>
