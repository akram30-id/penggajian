    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li <?php $here = 'dashboard'; ?> class="nav-item <?php if ($where === $here) {
                ...
                <a class="nav-link" href="<?= base_url() . 'ManagerAdministrasi'; ?>">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a <?php if ($where === "data_karyawan") {
                                ...
                                $status = "";
                            } ?> class="collapse-item <?= $status; ?>" href="<?= base_url() . 'ManagerAdministrasi/data_karyawan'; ?>">Data Master Karyawan</a>
                        <a <?php if ($where === "thr") {
                                $statusTabGaji = "active";
                            } else {
                                $statusTabGaji = "";
                            } ?> class="collapse-item <?= $statusTabGaji; ?>" href="<?= base_url() . 'ManagerAdministrasi/data_thr'; ?>">THR</a>
                        <a <?php if ($where === "pesangon") {
                                $statusTabGaji = "active";
                            } else {
                                $statusTabGaji = "";
                            } ?> class="collapse-item <?= $statusTabGaji; ?>" href="<?= base_url() . 'ManagerAdministrasi/data_pesangon'; ?>">Pesangon</a>
                        <a <?php if ($where === "data_gaji") {
                                $statusTabGaji = "active";
                            } else {
                                $statusTabGaji = "bg-success text-white rounded-pill mt-1";
                            } ?> class="collapse-item <?= $statusTabGaji; ?>" href="<?= base_url() . 'ManagerAdministrasi/data_gaji'; ?>">Rekap Gaji</a>
                    </div>
                </div>
            </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?php if ($admin_foto == "-") {
                                    ...
                                    $foto = base_url() . 'assets/img/karyawan/' . $admin_foto;
                                } ?>
