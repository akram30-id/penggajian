...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Hai, <?= $admin; ?></h1>
    </div>
    ...
    <div class="row justify-content-around mt-5">
        <div class="col-lg-4 mb-5">
            <canvas id="ChartGaji" style="margin-top: 72px;"></canvas>
            <a class="mt-5" href="<?= base_url() . 'ManagerAdministrasi/data_gaji'; ?>">Lihat Data Gaji &rarr;</a>
            <!-- CDN Chart JS -->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                ...
                                <a target="_blank" rel="nofollow" href="<?= base_url() . 'ManagerAdministrasi/data_karyawan'; ?>">Lihat Data Selengkapnya &rarr;</a>
                            </div>
                        </div>
