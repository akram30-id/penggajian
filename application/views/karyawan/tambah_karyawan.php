<div class="container-fluid">
    <div class="row">
        <div class="col-sm-4">
            <a href="<?= base_url() . 'hrd/data_karyawan'; ?>" class="btn btn-secondary mb-5">Back to Datasets</a>
        </div>
    </div>
        ...
        <div class="col-sm-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-group" action="<?= base_url() . 'hrd/act_tambah_karyawan'; ?>" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="bpjs" class="form-control" id="bpjs">
                            <div class="form-text"><?= form_error('bpjs'); ?></div>
                        </div>
                        <div class="mb-4">
