        ...
        <div class="col-sm-6">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url() . 'hrd/data_gaji'; ?>">Rekap Gaji</a></li>
            ...
            <div class="card" id="slipGaji">
                <div class="card-body">
                    ...
                    <div class="row justify-content-end mt-4 mb-4">
                        <div class="col-sm-4">
                            <?php if ($gaji[0]['ManagerSignature'] == "-") {
                                if ($gaji[0]['HrdSignature'] == "-") {
                                    $signation = "Need Your Approval";
                                } else if ($gaji[0]['HrdSignature'] != "-") {
                                    $signation = "Butuh Approval Manager Administrasi";
                                }
                            } else {
